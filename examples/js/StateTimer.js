...
export class StateTimer {
    constructor(audioctx,time_consume) {
    ...
    process_each_data_point(data_point,index){
        var [x_cord,y_cord,z_cord]= value2DtoCartersian(this.radius,this.timer,data_point.uniform_value,0,1,-Math.PI/3,+Math.PI/3,0,1,-0.5,+0.5);
      //  if (index==0){
            this.music_core.playSound(index,data_point.uniform_value,y_cord,x_cord,z_cord);
        //}
        console.log(this.timer,y_cord,x_cord,z_cord);
