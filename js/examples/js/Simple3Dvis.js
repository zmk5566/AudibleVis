...
import Stats from './three-libs/addons/libs/stats.module.js';
import { GUI } from './three-libs/addons/libs/lil-gui.module.min.js';
...
export class Simple3Dvis {
    ...
    init() {
        ...
        const geometry = new THREE.CylinderGeometry( 0.3, 0.3, 0.3, 4,5 );
        ...
        const temp_geometry = new THREE.BufferGeometry().setFromPoints( points );

        const line = new THREE.Line( temp_geometry, material );
        this.scene.add( line );
    ...
    update_point(index, x, y, z,color){
        ...
        const material = new THREE.MeshBasicMaterial( { color: color, flatShading: false } );
